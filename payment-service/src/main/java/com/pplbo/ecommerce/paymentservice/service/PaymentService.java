...
// @Transactional
// public PaymentResponse updatePayment(Long paymentId, PaymentRequest
// paymentRequest) {
// Payment payment = toPayment(paymentRequest);
...
// paymentOpt.map(Payment::getPaymentMethod).orElse(null);

// // In a real application, you would fetch these details from the order
// service
